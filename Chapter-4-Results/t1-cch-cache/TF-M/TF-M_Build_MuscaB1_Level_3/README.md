...
````batch
//in build dir:
cmake .. -DTFM_ISOLATION_LEVEL=3 -DTFM_PSA_API=ON -DCMAKE_BUILD_TYPE=Debug -DTFM_PLATFORM=C:/paper_tees_study/tees/TF-M/platform/ext/target/arm/musca_b1/sse_200 -DTFM_TOOLCHAIN_FILE=C:/paper_tees_study/tees/TF-M/toolchain_GNUARM.cmake -G"Unix Makefiles"
````
