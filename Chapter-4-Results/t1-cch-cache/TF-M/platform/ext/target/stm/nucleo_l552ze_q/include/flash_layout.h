...
//#define FLASH_S_PARTITION_SIZE          (0x2D000) /* S partition */ //old size
//#define FLASH_NS_PARTITION_SIZE         (0x9000) /* NS partition */ //old size
#define FLASH_S_PARTITION_SIZE          (0x3D000) /* S partition */ //chanegd by cris
#define FLASH_NS_PARTITION_SIZE         (0x19000) /* NS partition */ //chanegd by cris
#define FLASH_PARTITION_SIZE (FLASH_S_PARTITION_SIZE+FLASH_NS_PARTITION_SIZE)
/* Secure image primary slot */
#define FLASH_AREA_0_ID                 (1)
#define FLASH_AREA_0_OFFSET             (FLASH_ITS_AREA_OFFSET+FLASH_ITS_AREA_SIZE)
