...
//------added by cris------------------------
#define __TIMER6_BASE 0x50001000
#define __TIMER7_BASE 0x50001400 
#define __RCC_BASE 0x50021000

struct platform_data_t timer6 = {
        __TIMER6_BASE,
        __TIMER6_BASE + 0x3FF,
        -1,
        -1
...
void gtzc_init_cfg(void)
{
  ...
  //HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_TIM7, GTZC_TZSC_PERIPH_SEC | GTZC_TZSC_PERIPH_NPRIV);
