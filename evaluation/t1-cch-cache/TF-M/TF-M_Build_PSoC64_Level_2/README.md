...
````batch
//in build dir:
cmake .. -DTFM_ISOLATION_LEVEL=2 -DTFM_PSA_API=ON -DCMAKE_BUILD_TYPE=Debug -DTFM_PLATFORM=C:/paper_tees_study/tees/TF-M/platform/ext/target/cypress/psoc64 -DTFM_TOOLCHAIN_FILE=C:/paper_tees_study/tees/TF-M/toolchain_GNUARM.cmake -G"Unix Makefiles"
````
